...
+(NSString *)constructPostHTML : (AwfulPost *)post withBody : (NSString *)post_body alt : (NSString *)alt
{
    ...
    if(UI_USER_INTERFACE_IDIOM() == UIUserInterfaceIdiomPhone) {
        ...
        int tableWidth = 768 - 20;
        
        html = [NSString stringWithFormat:@"<div class='postbodymain %@' style='padding:10px;'><table id='%@' width='%dpx' ><tr><td valign='top' width=100px rowspan=3>%@</td><td valign='top'><span class='%@'>%@</span></td><td class='quotebutton' onclick=tappedPost('%@')>%@</td></tr><tr>%@</tr><tr><td><span class='post_date'>Posted On %@</span></td></tr></table></div>", 
                alt, post.postID, tableWidth, avatar_str, user_str, username_info, post.postID, [AwfulParse getPostActionHTML], parsed_post_body, post.postDate];
    }
